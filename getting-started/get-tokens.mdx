...
<Steps>
  ...
  <Step title="Confirm and wait">
    ...
    <video controls preload="metadata" playsInline className="w-full rounded-xl" src="/videos/qq2.mp4" />
  </Step>
</Steps>
...
2. Missed the dialog? Whenever your wallet holds wVARA, the
   ...
   <video controls preload="metadata" playsInline className="w-full rounded-xl" src="/videos/qq3.mp4" />
...
3. You can also convert on the bridge: open the
   ...
   <video controls preload="metadata" playsInline className="w-full rounded-xl" src="/videos/qq4.mp4" />
