...
1. After the swap, a **"Receive VARA"** dialog may appear — click it and
   you're done.
2. Missed the dialog? Open the bridge → **My Tokens** tab. If you see a wVARA
   balance, click **Convert To VARA**.

Your funds are never lost — if a balance looks missing, check the My Tokens
tab first, then refresh the page or reconnect your wallet.
