...
Vara Network's architecture keeps network fees near zero — a tiny amount of VARA per transaction, a fraction of a cent. In practice you pay the **0.35% swap fee**, and your very first swap is fully covered by a [gas voucher](/getting-started/voucher-guide) — no VARA needed to start.
